      ...
      child: Row(
        children: [
          if (ResponsiveLayout.isComputer(context))
            Container(
              margin: EdgeInsets.all(AppColors.kPadding),
          ...
          SizedBox(width: AppColors.kPadding),
          if (ResponsiveLayout.isComputer(context))
            OutlinedButton(
              onPressed: () {},
              child: Padding(
                padding: const EdgeInsets.all(AppColors.kPadding / 2),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        margin: EdgeInsets.all(AppColors.kPadding / 2),
                        width: 60,
                        height: 2,
